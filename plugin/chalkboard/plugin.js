...
*/
  ...
  window.toggleNotesCanvas = toggleNotesCanvas;
  ...
  window.toggleChalkboard = toggleChalkboard;
  ...
  for (var key in keyBindings) {
    if (keyBindings[key]) {
      Reveal.addKeyBinding(keyBindings[key], Plugin[key]);
    }
  }
...
const Plugin = {
  id: "RevealChalkboard",
  init: function (deck) {
    const cb = initChalkboard(deck);
    configure = cb.configure;
    toggleNotesCanvas = cb.toggleNotesCanvas;
    toggleChalkboard = cb.toggleChalkboard;
    colorIndex = cb.colorIndex;
    colorNext = cb.colorNext;
    colorPrev = cb.colorPrev;
    clear = cb.clear;
    updateStorage = cb.updateStorage;
    getData = cb.getData;
  },
